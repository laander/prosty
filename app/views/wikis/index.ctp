<div class="wikis index">
	...
	?>
	<tr<?php echo $class;?>>
		<td><?php echo $wiki['Wiki']['id']; ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($wiki['User']['username'], array('controller' => 'users', 'action' => 'view', $wiki['User']['id'])); ?>
		</td>
		<td><?php echo $wiki['Wiki']['title']; ?>&nbsp;</td>
		<td><?php echo $wiki['Wiki']['body']; ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($wiki['Parent']['title'], array('controller' => 'wikis', 'action' => 'view', $wiki['Parent']['id'])); ?>
		</td>
		<td><?php echo $wiki['Wiki']['created']; ?>&nbsp;</td>
		<td><?php echo $wiki['Wiki']['modified']; ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View', true), array('action' => 'view', $wiki['Wiki']['id'])); ?>
