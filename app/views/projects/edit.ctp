...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('List User Projects', true), array('controller' => 'user_projects', 'action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New User Project', true), array('controller' => 'user_projects', 'action' => 'add')); ?> </li>
	</ul>
</div>